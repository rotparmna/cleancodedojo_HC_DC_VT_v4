...
<asp:Content ID="Content2" ContentPlaceHolderID="contenedorPrincipal" runat="server">
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            OrdenarGrilla('grillaEntidades');
            OrdenarGrilla('grillaVentas');
        ...
        function ValidarConsecutivo() {
            gridEntidades = $('[id$=grillaEntidades]');
                ...
                <div id="tabs">
                    ...
                    <div id="tabs-1">
                        ...
                        <div id="divEntidades">
                            ...
                            <asp:GridView ID="grillaEntidades" runat="server" AutoGenerateColumns="False" CssClass="AspNet-GridView"
                                OnRowCommand="grillaEntidades_RowCommand">
                                <Columns>
                    ...
                    <div id="tabs-2">
                        ...
                        <div id="divVentas" style="max-height: 300px; min-height: 50px; overflow-x: hidden; overflow-y: scroll;">
                            <asp:GridView ID="grillaVentas" runat="server" AutoGenerateColumns="False" CssClass="AspNet-GridView" DataKeyNames="NumeroVenta">
                                <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                    ...
                                    <asp:BoundField HeaderText="<%$ Resources:AdministradorFacActividades, FacActividad_grillaVentas_Transaccion %>"
                                        DataField="NombreTransaccion"
                                        SortExpression="NombreTransaccion" />
                                    <asp:BoundField HeaderText="<%$ Resources:AdministradorFacActividades, FacActividad_grillaVentas_NumeroVenta %>"
                                        DataField="NumeroVenta"
                                        SortExpression="NumeroVenta" />
                                    <asp:BoundField HeaderText="<%$ Resources:AdministradorFacActividades, FacActividad_grillaVentas_FechaVenta %>"
                                        DataField="FechaVenta"
                                        ItemStyle-CssClass="Centrado"
                                        DataFormatString="{0:d}"
                                        SortExpression="FechaVenta" />
                                    <asp:BoundField HeaderText="<%$ Resources:AdministradorFacActividades, FacActividad_grillaVentas_UbicacionConsumo %>"
                                        DataField="NombreUbicacionConsumo"
                                        SortExpression="NombreUbicacionConsumo" />
                                    <asp:BoundField HeaderText="<%$ Resources:AdministradorFacActividades, FacActividad_grillaVentas_UbicacionEntrega %>"
                                        DataField="NombreUbicacionEntrega"
                                        SortExpression="NombreUbicacionEntrega" />
                                    <asp:BoundField HeaderText="<%$ Resources:AdministradorFacActividades, FacActividad_grillaVentas_AtencionEnlazada %>"
